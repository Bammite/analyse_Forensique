...
# UTILITAIRES
# =========================
def find_latest_pcap(directory: Path) -> Path | None:
...
if pcap_path is None:
    print("[!] Aucun fichier pcap trouve dans le dossier captures/")
    raise SystemExit(1)
...
for packet in packets:
    ...
    if packet.haslayer(UDP):
        ...
        # Détection exfiltration UDP ciblée
